...
type CronTask_CustomCreateStateMsg struct {
	CustomCreateStateMsg *custom.CreateStateMsg `protobuf:"bytes,101,opt,name=custom_create_state_msg,json=customCreateStateMsg,proto3,oneof"`
}

func (*CronTask_CustomCreateStateMsg) isCronTask_Sum() {}
...
func (m *CronTask) GetCustomCreateStateMsg() *custom.CreateStateMsg {
	if x, ok := m.GetSum().(*CronTask_CustomCreateStateMsg); ok {
		return x.CustomCreateStateMsg
	}
	return nil
}
...
func (*CronTask) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _CronTask_OneofMarshaler, _CronTask_OneofUnmarshaler, _CronTask_OneofSizer, []interface{}{
		(*CronTask_CustomCreateStateMsg)(nil),
	}
}
...
func _CronTask_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	// sum
	switch x := m.Sum.(type) {
	case *CronTask_CustomCreateStateMsg:
		_ = b.EncodeVarint(101<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.CustomCreateStateMsg); err != nil {
			return err
		}
...
func _CronTask_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 101: // sum.custom_create_state_msg
		...
		msg := new(custom.CreateStateMsg)
		err := b.DecodeMessage(msg)
		m.Sum = &CronTask_CustomCreateStateMsg{msg}
		return true, err
	default:
		return false, nil
	}
...
var fileDescriptor_e43b82f4f03f64b8 = []byte{
	...
	,
}
...
func (m *CronTask_CustomCreateStateMsg) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.CustomCreateStateMsg != nil {
		dAtA[i] = 0xaa
		i++
		...
		i++
		i = encodeVarintCodec(dAtA, i, uint64(m.CustomCreateStateMsg.Size()))
		n12, err := m.CustomCreateStateMsg.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *CronTask_CustomCreateStateMsg) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CronTask) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 101:
			...
			m.Sum = &CronTask_CustomCreateStateMsg{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCodec(dAtA[iNdEx:])
